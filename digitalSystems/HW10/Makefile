...
# We want our users to have a simple API to run the JackAnalyzer, no matter the language
...
# run file executable to run. The executable for project 6 should be called JackAnalyzer.
...
# In the case of Project 7, it is "JackAnalyzer":
EXEC=JackAnalyzer
...
# and then gives execution permissions to the run file called JackAnalyzer
compile:
